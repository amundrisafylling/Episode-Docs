...
| Connection | Yes | A valid [InVision Connection](invision-connection.md) used to deploy the view. |
| View | Yes | The ID of the view definition in InVision to be deployed. |
