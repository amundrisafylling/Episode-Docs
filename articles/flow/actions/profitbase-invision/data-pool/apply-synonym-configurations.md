...
| Connection  | Required | Defines the [InVision connection](../invision-connection.md) used to access the Hypergene InVision environment. The connection contains the credentials required to execute the action. |
