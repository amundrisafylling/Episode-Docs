...
![REST API Paging Trip](/images/flow/rest-api-paging-trip.png)  
<br/>
...
| Start index     | No | The starting point of the index for data retrieval. Defaults to 0 if not specified.           |
