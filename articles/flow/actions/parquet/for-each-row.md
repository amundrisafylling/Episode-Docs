...
| Column mapping    | Yes | Defines the mapping between Parquet column names and business object property names.           |
| Row variable name | No | The name of the Row variable.                                              |
