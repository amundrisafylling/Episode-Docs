...
![Generate Embedding](../../../../images/flow/generate-embedding.png)
...
| Result variable name | Yes | Defines the variable name in which the result will be stored. `TextEmbedder`![Example](../../../../images/strz2.jpg). |
